...
export const ReadiumView = React.forwardRef(({ file, preferences, decorations, onLocationChange, onPublicationReady, onDecorationActivated, style = {}, height, width, requestConfig, }, ref) => {
