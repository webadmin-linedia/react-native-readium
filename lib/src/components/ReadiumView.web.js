...
export const ReadiumView = React.forwardRef(({ file, preferences, decorations, onLocationChange, onPublicationReady, onDecorationActivated, style = {}, height, width, requestConfig, allowedDomains, }, ref) => {
    ...
    return (<View style={styles.container} id="wrapper">
        ...
        <main ref={setContainer} style={styles.readiumContainer} id="readium-container" aria-label="Publication"/>
      </View>);
});
const loaderStyle = {
    width: '100%',
